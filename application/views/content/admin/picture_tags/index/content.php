          ...
          <tr>
            ...
            <td data-title='是否顯示' width='90'>
              <label class='index_checkbox'>
                <input type='checkbox' data-id='<?php echo $tag->id;?>'<?php echo $tag->is_on_site == PictureTag::IS_ON_SITE_NAMES ? ' checked' : '';?>>
                <span></span><div><?php echo PictureTag::$isOnSiteNames[$tag->is_on_site];?></div>
              </label>
            </td>
            <td data-title='編輯' width='120'>
              <a href='<?php echo base_url ('admin', 'tag', $tag->id, 'pictures');?>' class='icon-images'></a>
