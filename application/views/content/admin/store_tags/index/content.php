          ...
          <tr>
            ...
            <td data-title='是否顯示' width='90'>
              <label class='index_checkbox'>
                <input type='checkbox' data-id='<?php echo $tag->id;?>'<?php echo $tag->is_on_site == StoreTag::IS_ON_SITE_NAMES ? ' checked' : '';?>>
                <span></span><div><?php echo StoreTag::$isOnSiteNames[$tag->is_on_site];?></div>
              </label>
            </td>
