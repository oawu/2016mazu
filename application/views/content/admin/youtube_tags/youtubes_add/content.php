<form action='<?php echo base_url (array ('admin', 'youtube_tags', $tag->id, 'youtubes', 'create'));?>' method='post' enctype='multipart/form-data'>
  <table class='table-form'>
    <tbody>
      ...
      <tr>
        <th>影片來源：</th>
        <td>
          <input type='text' name='url' value='<?php echo $posts['url'] ? $posts['url'] : '';?>' placeholder='請輸入影片網址..' title='輸入影片網址!' />
        </td>
      </tr>
      ...
      <tr>
        <td colspan='2'>
          <a href='<?php echo base_url ('admin', 'youtube_tags', $tag->id, 'youtubes');?>'>回列表</a>
