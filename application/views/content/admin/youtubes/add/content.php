<form action='<?php echo base_url (array ('admin', 'youtubes', 'create'));?>' method='post' enctype='multipart/form-data'>
...
<?php }?>
      ...
      <tr>
        <td colspan='2'>
          <a href='<?php echo base_url ('admin', 'youtubes');?>'>回列表</a>
