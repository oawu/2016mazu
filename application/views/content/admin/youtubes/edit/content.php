<form action='<?php echo base_url (array ('admin', 'youtubes', $youtube->id));?>' method='post' enctype='multipart/form-data'>
...
<?php if ($tags = YoutubeTag::all ()) { ?>
        <tr>
          <th>標 籤：</th>
          <td>
      <?php $tag_ids = column_array ($youtube->mappings, 'youtube_tag_id');
            foreach ($tags as $tag) { ?>
