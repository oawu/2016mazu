...
<?php if ($dintaos) {
        foreach ($dintaos as $dintao) { ?>
          <tr>
            ...
            <td data-title='標籤' width='150'><?php echo $dintao->tags ? implode ('', array_map (function ($tag) { return anchor (base_url ('admin', 'dintao-tag', $tag->id, 'dintaos'), $tag->name, 'class="tag"'); }, $dintao->tags)) : '-';?></td>
