        ...
        foreach ($youtubes as $youtube) { ?>
          <tr>
            ...
            <td data-title='排序' width='60' class='sort'>
              <a href='<?php echo base_url ('admin', 'youtube_tags', $tag->id, 'youtubes', $youtube->id, 'sort', 'up');?>' data-method='post' class='icon-triangle-up'></a>
              <a href='<?php echo base_url ('admin', 'youtube_tags', $tag->id, 'youtubes', $youtube->id, 'sort', 'down');?>' data-method='post' class='icon-triangle-down'></a>
            </td>
          </tr>
  <?php }
      } else { ?>
