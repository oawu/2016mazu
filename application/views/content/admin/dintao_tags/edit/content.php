<form action='<?php echo base_url (array ('admin', 'dintao_tags', $tag->id, 'update'));?>' method='post' enctype='multipart/form-data'>
  <table class='table-form'>
    <tbody>
      ...
      <tr>
        <td colspan='2'>
          <a href='<?php echo base_url ('admin', 'dintao_tags');?>'>回列表</a>
