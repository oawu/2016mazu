        ...
        foreach ($tags as $tag) { ?>
          <tr>
            ...
            <td data-title='排序' width='60' class='sort'>
              <a href='<?php echo base_url ('admin', 'dintao_tags', $tag->id, 'sort', 'up');?>' data-method='post' class='icon-triangle-up'></a>
              <a href='<?php echo base_url ('admin', 'dintao_tags', $tag->id, 'sort', 'down');?>' data-method='post' class='icon-triangle-down'></a>
            </td>
          </tr>
  <?php }
      } else { ?>
