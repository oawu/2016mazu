<form action='<?php echo base_url ('admin', 'pictures', $tab_index);?>' method='get' class="search<?php echo $has_search ? ' show' : '';?>">
  <div class='l i2 n1'>
  ...
  <a href='<?php echo base_url ('admin', 'pictures', 'add', $tab_index);?>'>新增</a>
</form>
...
<?php if ($pictures) {
        foreach ($pictures as $picture) { ?>
          <tr>
            ...
            <td data-title='內容' width='' class='left'><?php echo $picture->mini_content ();?></td>
            <td data-title='關鍵字' width='150' class='left'><?php echo $picture->mini_keywords ();?></td>
            <td data-title='編輯' width='80'>
              <a href='<?php echo base_url ('admin', 'pictures', 'edit', $picture->id);?>' class='icon-pencil2'></a>
              <a href='<?php echo base_url ('admin', 'pictures', 'destroy', $picture->id);?>' class='icon-bin destroy'></a>
            </td>
