        ...
        foreach ($pictures as $picture) { ?>
          <tr>
            ...
            <td data-title='編輯' width='80'>
              <a href='<?php echo base_url ('admin', $uri_1, $picture->id, 'edit');?>' class='icon-pencil2'></a>
              <a href='<?php echo base_url ('admin', $uri_1, $picture->id);?>' data-method='delete' class='icon-bin destroy'></a>
            </td>
          </tr>
  <?php }
      } else { ?>
