...
<?php
  if ($pictures) {
    foreach ($pictures as $picture) { ?>
      <figure>
        <a href='<?php echo base_url ('picture', $method, $picture->id . '-' . urlencode ($picture->title));?>' data-size="<?php echo $picture->width;?>x<?php echo $picture->height;?>" src="<?php echo $picture->name->url ();?>" class='i_c'>
