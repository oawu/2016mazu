...
$admin['menu'] = array (
    ...
    '其他' => array (
        ...
        'GPS 資訊' => array ('roles' => array ('root'), 'icon' => 'icon-location', 'href' => base_url ('admin', 'march-infos'), 'class' => 'march_infos', 'method' => '', 'target' => '_self'),
        // '白沙屯位置資訊' => array ('roles' => array ('baishatun'), 'icon' => 'icon-location', 'href' => base_url ('admin', 'baishatun-path-infos'), 'class' => 'baishatun_path_infos', 'method' => '', 'target' => '_self'),
