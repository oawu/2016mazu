...
class Migration_Add_others extends CI_Migration {
  public function up () {
    $this->db->query (
      "CREATE TABLE `others` (
        ...
        `type` varchar(50) COLLATE utf8_unicode_ci NOT NULL COMMENT '類別',
        ...
        KEY `type_destroy_user_id_is_enabled_index` (`type`, `destroy_user_id`, `is_enabled`),
