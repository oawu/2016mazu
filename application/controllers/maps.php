...
class Maps extends Site_controller {
  ...
  public function __construct () {
    ...
    $this->dintao_tabs = array (
        ...
        array ('id' => 3, 'title' => '二十下午', 'desc' => '出廟➜中山路➜民生路➜義民路➜光明路➜博愛路➜代天宮前➜義民路192巷➜義民路➜文化路➜太平路➜文仁路➜公園路➜民政路➜北辰路➜民治路➜公園路➜民族路➜吉祥路➜民有路➜文昌路➜民治路➜公園路➜民享路➜華勝路➜民政路➜公園路➜文星路➜華勝路➜文明路➜大同路516巷出➜長安街➜協和街➜長治街➜介壽街➜文仁路➜大同路➜右轉舊太子宮邊➜懷恩街➜文仁路➜民樂路➜文星路➜仁愛路➜民政路➜華勝路➜民治路➜民樂路➜民享路➜大同路➜義民路➜中正路➜花旗銀行前➜郵局前➜文化路➜光明路➜義民路➜旌義街➜義民廟前➜博愛路➜中華路➜共和街➜安和街➜中山路➜光明路➜德為街➜信義路➜興南街➜民生路➜益安路➜中華路➜中山路➜入廟'),
        array ('id' => 4, 'title' => '二十晚上', 'desc' => '出廟➜中山路➜民生路➜水源街➜東興街➜益安路➜公民路➜仁和路➜三連街➜公館街➜仁德街➜舊台南中小企銀前➜博愛路➜中興街➜媽祖廟東邊➜媽祖廟前媽祖廟西邊➜中正路➜文化路➜嘉義客運前➜公民路➜義民路➜大同路➜博愛路➜代天宮前➜復興街➜文化路➜郵局前➜文化路➜文化路27巷➜文明巷➜慈德堂前➜光明路➜南陽國小前➜文化路➜西勢街➜義民路➜民主路➜博愛路➜光明路➜新興街➜信義路➜義民路➜民生路➜中山路➜入廟'),
      );
    $this->iko_tabs = array (
        array ('id' => 5, 'title' => '十九下午', 'desc' => '廟前起馬➜中山路➜東引道➜陸橋➜義民路➜民主路➜文化路➜大同路➜華勝路➜民享路➜公園路➜民治路➜北辰路➜文化路➜太平路➜文仁路➜北辰路➜公園路➜文仁路➜民樂路➜文明路➜仁愛路➜民享路➜華勝路➜華南路➜休息'),
        array ('id' => 6, 'title' => '十九晚間', 'desc' => '廟前出發➜中山路➜東引道➜陸橋➜義民路➜大同路➜文昌路➜民族路➜文化路➜民有路➜華勝路➜民治路➜民樂路➜民政路➜公園路➜文星路➜華勝路➜大同路➜文化路➜民主路➜義民路➜陸橋➜東引道➜中山路➜休息'),
        array ('id' => 7, 'title' => '二十下午', 'desc' => '廟前出發➜中山路➜東引道➜陸橋➜義民路➜大同路➜華勝路➜民享路➜民樂路➜穎寧街➜華勝路➜北辰派出所前➜新街巡天宮前迴轉南向➜北辰派出所前➜華勝路➜文仁路➜吉祥路➜文明路➜公園路➜文星路➜吉祥路➜民有路➜華勝路➜華南路➜休息'),
        array ('id' => 8, 'title' => '二十晚間', 'desc' => '廟前出發➜中山路➜民生路➜義民路➜民主路➜文化路➜中正路➜仁和路➜大同路➜文昌路➜文明路➜華勝路➜民政路➜公園路➜文化路➜民主路➜義民路➜陸橋➜東引道➜中山路➜休息'),
        array ('id' => 9, 'title' => '廿一晚間', 'desc' => '廟前出發➜中山路➜民生路➜益安路➜大同路➜義民路➜中正路➜廟後➜廟東➜廟前➜中山路➜光明路➜文化路➜圓環➜休息'),
        array ('id' => 10, 'title' => '廿二晚間', 'desc' => '廟前出發➜中山路➜集合後開始評審➜民生路➜益安路➜公民路➜文化路➜民主路➜義民路➜民生路➜中山路➜廟前定點評審➜民主路➜圓環➜休息'),
        array ('id' => 11, 'title' => '廿三晚間', 'desc' => '廟前出發➜中山路➜民生路➜義民路➜大同路➜新民路➜中正路➜仁和路➜益安路➜民生路➜中山路➜廟前頒獎及落馬儀式➜民主路➜圓環➜圓滿結束'),
      );
