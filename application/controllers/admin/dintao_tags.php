...
class Dintao_tags extends Admin_controller {
  ...
  public function dintaos ($id, $offset = 0) {
    if (!($id && ($tag = DintaoTag::find_by_id ($id))))
      return redirect_message (array ('admin', $this->get_class ()), array (
          '_flash_message' => '找不到該筆資料。'
        ));
  ...
  public function add_dintaos ($id) {
    if (!($id && ($tag = DintaoTag::find_by_id ($id))))
      return redirect_message (array ('admin', $this->get_class ()), array (
          '_flash_message' => '找不到該筆資料。'
        ));
  ...
  public function create_dintaos ($id) {
    if (!($id && ($tag = DintaoTag::find_by_id ($id))))
      return redirect_message (array ('admin', $this->get_class ()), array (
          '_flash_message' => '找不到該筆資料。'
        ));
  ...
  public function edit_dintaos ($tag_id, $dintao_id) {
  ...
  public function update_dintaos ($tag_id, $dintao_id) {
    if (!($tag_id && ($tag = DintaoTag::find_by_id ($tag_id))))
      return redirect_message (array ('admin', $this->get_class ()), array (
          '_flash_message' => '找不到該筆資料。'
        ));
  ...
  public function destroy_dintaos ($tag_id, $dintao_id) {
    if (!($tag_id && ($tag = DintaoTag::find_by_id ($tag_id))))
      return redirect_message (array ('admin', $this->get_class ()), array (
          '_flash_message' => '找不到該筆資料。'
        ));
  ...
  public function sort_dintaos ($id) {
    if (!($id && ($tag = DintaoTag::find_by_id ($id))))
      return $this->output_json (array ('status' => false));
